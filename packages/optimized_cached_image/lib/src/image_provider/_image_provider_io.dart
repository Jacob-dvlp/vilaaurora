...
class OptimizedCacheImageProvider
  ...
  Stream<ui.Codec> _loadAsync(
    ...
    assert(key == this);
    try {
      final BaseCacheManager mngr = cacheManager ?? DefaultImageCacheManager();
      assert(
      ...
      final Stream<FileResponse> stream = mngr is OicImageCacheManager
      ...
      await for (FileResponse result in stream) {
