...
class PsConfig {
  ...
  ///
  static const String ps_api_key = 'angolaviladecasa1';

  ///
  /// API URL
  /// Change your backend url
  ///
  static const String ps_core_url = 'https://app.villaaurora.store';
  ...
  /// Facebook Key
  ///
  static const String fbKey = '226600682459329';
...
// static const ps_language_list = [Locale('en', 'US'), Locale('ar', 'DZ')];
  ...
  /// ",##0.0"    => 2555.0
  ///
  static const String priceFormat = ',##0.00kz';
